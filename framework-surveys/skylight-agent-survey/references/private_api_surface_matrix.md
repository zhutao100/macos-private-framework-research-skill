...
| Spaces/displays | `SLSCopyManagedDisplaySpaces`, `SLSCopySpacesForWindows`, `SLSMoveWindowsToManagedSpace` | Very limited public APIs | Mission Control/Space graph; off-Space window membership | Fragile across releases. |
